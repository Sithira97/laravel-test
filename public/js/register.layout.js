...
const inputsAndSelects = formSelected.querySelectorAll('.register-modal .main input,.register-modal .main select');
const gileGalleries = document.querySelectorAll('.register-modal .main .upload_gallery');
...
function resetActiveFields() {
    let inputsAndSelectsActive = formSelected.querySelectorAll('.register-modal .main.active-view input,.register-modal .main.active-view select,.register-modal .main.active-view td, .register-modal .main.active-view div.upload_gallery');
    ...
    let gileGalleriesActive = document.querySelectorAll('.register-modal .main.active-view .upload_gallery');
...
function nextClicked_validateform() {
    validate = true;
    const activeMain = formSelected.querySelector('.register-modal .main.active-view')
...
function removeRow(button) {
    const table = button.previousElementSibling.querySelector('table');
    const lastRow = table.querySelector('tbody').deleteRow(-1);
}
...
$(() => { $("#includedResetModal").load("../reset.modal.html"); });
